-- Crea una funzione RPC per ottenere i veicoli dell'utente
-- Questo bypassa il problema dello schema PostgREST

CREATE OR REPLACE FUNCTION public.get_user_vehicles(user_id uuid)
RETURNS TABLE (
    veicolo_id uuid,
    nomeveicolo text,
    targa text,
